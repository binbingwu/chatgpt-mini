<template>
	<view class="bg">
		<image src="../../static/1.png" mode="scaleToFill" class="bg-img"></image>
			...
			<view scroll-with-animation>
				<view class="flex-column-start" v-for="(o,i) in msgList" :key="i" :id="'text'+i">
					...
					<view v-if="!o.my" class="aiinfo">
						<view class="chat-img ">
							<image style="height: 100rpx;width: 100rpx;" src="../../static/2.png" mode="scaleToFill">
							</image>
						</view>
	...
	export default {
		data() {
			return {
				...
				num: 5, //次数
				apiurl: '', //后端转发地址
				api: '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', //在此输入你的apikey
